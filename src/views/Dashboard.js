...
const Dashboard = () =>{
  ...
  useEffect(()=>{
    dispatch(getDashboardData(authState));
    return () => {};
  },[authState])
      return (
      <>
                  ...
                  <Row>
                    ...
                    <Col md="8" xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle tag="p">{!loading ? dashboard.users:""}</CardTitle>
                        <p />
                      </div>
                    </Col>
                  </Row>
            ...
            <Col lg="3" md="6" sm="6">
              <Card className="card-stats">
                ...
                <CardFooter>
                  <hr />
                  <div className="stats">
                    <i className="far fa-calendar" />All Matches
                  </div>
                </CardFooter>
              </Card>
            </Col>
                  ...
                  <Row>
                    ...
                    <Col md="8" xs="7">
                      <div className="numbers">
                        ...
                        <CardTitle tag="p">{!loading ? dashboard.newUsers:""}</CardTitle>
                        <p />
                      </div>
                    </Col>
                  </Row>
